...
import { AdminExpensesPageClient } from "@/components/portals/admin-expenses-page-client";
...
async function ExpensesContent({ searchParams }: { searchParams: Promise<{ projectId?: string }> }) {
  ...
  return (
    <>
      ...
      />
      <AdminExpensesPageClient endpoint={endpoint} />
    </>
  );
}

export default function AdminExpensesPage({ searchParams }: PageProps) {
